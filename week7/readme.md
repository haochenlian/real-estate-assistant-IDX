[README.md](https://github.com/user-attachments/files/30812738/README.md)
...
> **Note on where these numbers come from:** the 60/40 split and every point value
> below are **specified by the program handbook**, not chosen by me. The spec defines
> structured similarity as 60% of the score and semantic similarity as 40%, with the
> exact bands listed in the tables. This implementation follows those values directly.
